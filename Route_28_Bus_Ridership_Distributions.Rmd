...
hist(y_geom,                                          # Plot of randomly drawn geom density
     breaks = 100,
...
nbBin10<-pnbinom(10.5, size = r_MM, prob = p_MM, lower.tail = TRUE, log.p = FALSE)-nbBin0-nbBin1-nbBin2-nbBin3-nbBin4-nbBin5-nbBin6-nbBin7-nbBin8-nbBin9
nbBin11<-pnbinom(11.5, size = r_MM, prob = p_MM, lower.tail = TRUE, log.p = FALSE)-nbBin0-nbBin1-nbBin2-nbBin3-nbBin4-nbBin5-nbBin6-nbBin7-nbBin8-nbBin9-nbBin10
nbBin12<-pnbinom(11.5, size = r_MM, prob = p_MM, lower.tail = FALSE, log.p = FALSE)

nbPs<-c(nbBin0,nbBin1,nbBin2,nbBin3,nbBin4,nbBin5,nbBin6,nbBin7,nbBin8,nbBin9,nbBin10,nbBin11,nbBin12)
...
merged_binom2[7,]<-merged_binom2[7,]+merged_binom2[8,]+merged_binom2[9,]+merged_binom2[10,]+merged_binom2[11,]+merged_binom2[12,]+merged_binom2[13,]
merged_binom2<-merged_binom2[-8:-13,]
merged_binom2$y_nbinom<-as.numeric(merged_binom2$y_nbinom)
merged_binom2$y_nbinom[is.na(merged_binom2$y_nbinom)] <- "Bin 6-12"
...
######RUN 1000 SIMULATIONS OF EACH DISTRIBUTION AND ASSESS ACCURACY########
